 ...
 * @param center
 */
export function layoutHintDataPropsForCenter(center) {
    const props = {};
    if (!isChrome || RenderTarget.current() !== RenderTarget.canvas) {
        return props;
    }
...
//# sourceMappingURL=layoutHintDataPropsForCenter.js.map